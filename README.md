...
| controls.thumbnails:<br>{ disable: boolean; icon: string; porition: 'right' | 'left' | 'top' | 'bottom'; } | Thumbnails control configuration.<br>default = { disable: false, icon: 'list' position: 'right' }                                                                                                          |
...
| animations.toolbarHide:<br>{ duration: number; }                       | Toolbar show animation configuration.<br>default = { duration: .4 }                                                                                                        |
| animations.toolbarShow:<br>{ duration: number; }                       | Toolbar hide animation configuration.<br>default = { duration: .05 }                                                                                                       |
